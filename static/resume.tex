...
{Senior Software Engineer -- Go, Kubernetes }{March 2023 - March 2024}
\resumeItemListStart
...
{
    Introduced and managed new development and staging enviroment using amazon EKS,
...
{
    Added persistent storage on NATS to support messages redelivery for mission
